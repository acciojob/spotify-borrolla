...
public class SpotifyController {
    ...
    public ResponseEntity<User> createUSer(@RequestParam(name = "name") String name, String mobile) {
    ...
    public <songTitle> String findPlaylist(@RequestParam(name = "mobile") String mobile, @RequestParam(name = "playlistTitle") String playlistTitle) throws Exception {
        ...
        @PutMapping("/like_song")
        public String likeSong (@RequestParam(name = "mobile") String mobile, @RequestParam(name = "songTitle")
        String  songTitle) throws Exception
    {
        ...
        public String mostPopularArtist() {
            ...
            return artistDB.values().stream().max(Comparator.comparingInt(Artist::getLikeCount)).map(Artist::getName).
        ...
        public String mostPopularSong() {
            ...
            return songDB.values().stream().max(Comparator.comparingInt(Song::getLikeCount)).map(Song::getTitle).
